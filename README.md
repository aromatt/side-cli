...
* `%1` is a "stream variable", i.e. a placeholder for injecting values generated by a
  coprocess into the output stream. The variable `%n` refers to the nth coprocess
  specified.
